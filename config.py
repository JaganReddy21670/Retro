...
ROI_PADDING = {
    "top": -7,    # Shrink top by 7%
    "bottom": -7, # Shrink bottom by 7%
    "left": -14,  # Perfect balance between -10 and -18 to hide sticker but protect '4'
    "right": -28  # Aggressively shrink to completely cut off the right marker
}
